...
class ProProducto
{
    ...
    /**
     * @var \AgenciaBundle\Entity\AgeUsuario
     *
     * @ORM\ManyToOne(targetEntity="AgenciaBundle\Entity\AgeUsuario")
     * @ORM\JoinColumns({
     ...
     * Set proUsuarioFk
     *
     * @param \AgenciaBundle\Entity\AgeUsuario $proUsuarioFk
     * @return ProProducto
     */
    public function setProUsuarioFk(\AgenciaBundle\Entity\AgeUsuario $proUsuarioFk = null)
    {
     ...
     * Get proUsuarioFk
     *
     * @return \AgenciaBundle\Entity\AgeUsuario 
     */
